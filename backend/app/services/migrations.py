...
_REQUIRED_COLUMNS: list[tuple[str, str, str, str | None]] = [
    ...
    # v1.3: SSH broker hosts for externally-managed clusters (start/restart)
    ("clusters", "external_broker_hosts_json", "TEXT", None),
    # v1.3.5 — multi-cluster /opt/kafka collision fix
